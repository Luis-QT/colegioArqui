        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <img src="{{ asset('img/user.jpg') }}" class="img-circle" alt="{{ Auth::user()->apellidos }}">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ asset('img/user.jpg') }}" style="height:37px !important;" class="img-circle" alt="{{ Auth::user()->apellidos }}">
        </div>
